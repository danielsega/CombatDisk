...
ai_timer			ds 1		;CC - This timer will dec itselft till reaches Zero
ai_position_x		ds 1		;CD - This will tell the X position the ai is going
ai_position_y		ds 1		;CE - This will tell the y position the ai is going
ai_throw_bool		ds 1		;CF - This will tell the ai to throw the ball. False - Don't Throw, True - Throw
ai_error_margin		ds 1		;D0 - This will contain a small magin error to catch the ball
ai_jump_bool		ds 1		;D1 - This will tell the ai to jump. False - Don't Jump, True - Jump   
;==============================================================
;END OF VARIABLES
;==============================================================
...
contine_super_position:
	...
	;If Super is On change Ai_Position_X to super location
	lda is_super_on_screen
	beq skip_go_to_super_x	
