...
last_sound_index	ds 1		;C5 - This will contain the last index and compare to the current one in order to see if we can change the sound
music_timer			ds 1		;C6	- This timer will keep track of bps for music
sound_timer			ds 1		;C7	- This timer will keep track of bps for sound

;GAME INDEX
event_index			ds 1		;C8 
event_timer			ds 1		;C9
event_checker		ds 1		;CA

;Game Start Helper
start_ball_vel_x	ds 1		;CB - Checks which player will start with the ball and store initial ball velocity to tell where it is going.
who_won				ds 1		;CC - Case 0 : P0 Wins, Case 1: P1 Wins

;AI
is_ai_on			ds 1		;CD - Case Bool True: It's a single Player game, Case False: It's a two player game
ai_dir				ds 1		;CE - This will those the direction that the AI is gonna take
ai_timer			ds 1		;CF - This timer will dec itselft till reaches Zero
ai_position_x		ds 1		;D0 - This will tell the X position the ai is going
ai_position_y		ds 1		;D1 - This will tell the y position the ai is going
ai_throw_bool		ds 1		;D2 - This will tell the ai to throw the ball. False - Don't Throw, True - Throw
ai_error_margin		ds 1		;D3 - This will contain a small magin error to catch the ball
ai_jump_bool		ds 1		;D4 - This will tell the ai to jump. False - Don't Jump, True - Jump
;==============================================================
;END OF VARIABLES
;==============================================================
...
music_cv_game_over:
	.byte $76, $76, $76, $76, $76, $74, $74
music_f_game_over:
	.byte 22, 18, 18, 22, 22, 16, 16
